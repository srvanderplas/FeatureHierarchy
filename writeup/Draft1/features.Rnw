...
\[
E[\rho] = \frac{\frac{1}{3}a^2}{\frac{1}{3}a^2 + \sigma^2_T},
\]
because
$E[RSS] = N\sigma^2_T$ and $E[TSS] = \sum_{i=1}^N E[y_i^2]$  (as $E[Y] = 0$), where 
\[
E[y_i^2] = E[a^2 x_i^2 + e_i^2 + 2 ax_ie_i] = \frac{1}{3}a^2 + \sigma^2_T. 
\]
