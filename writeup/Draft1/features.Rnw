...
\cellcolor{gray!25}\begin{tabular}{c} \\ Cluster \end{tabular} & 1 &  \cellcolor{gray!15} Color/Shape & \cellcolor{gray!5} Color + Line \\
...
p1 <- qplot(cluster.diff2, accuracy, data=parm.accuracy, facets=k2~trend.diff2, size=answer.type, colour=answer.type, shape=answer.type) + 
  theme_bw() + xlab("") + 
  geom_line(aes(group=answer.type), size=1) + 
  scale_colour_brewer("Target Identified", palette="Set1") + 
  scale_shape_manual("Target Identified", values=c(1,4, 19)) + 
...
p2 <- qplot(trend.diff2, accuracy, data=parm.accuracy, facets=k2~cluster.diff2, size=answer.type, colour=answer.type, shape=answer.type) + 
  theme_bw() + xlab("") + 
  geom_line(aes(group=answer.type), size=1) + 
  scale_colour_brewer("Target Identified", palette="Set1") + 
  scale_shape_manual("Target Identified", values=c(1,4, 19)) + 
