...
\comment{I don't know where the demographic information for the experiment is stored... HH: I'll check with Eric for it - it should go into an appendix, I think}
