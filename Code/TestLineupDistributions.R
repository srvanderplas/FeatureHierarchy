...
save(simulation.results, file = "./Data/SimulationResultsTurk16.Rdata")

load("./Data/SimulationResultsTurk16.Rdata")
...
save(dataset.criteria, file="./Data/SimulationDatasetCriteriaTurk16.Rdata")
