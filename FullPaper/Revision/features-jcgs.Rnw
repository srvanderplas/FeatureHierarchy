...
\subsection{Participant Recruitment and Task Description}
...
The webpage used to collect data from Amazon Turk participants is available at \url{http://www.mlcape.com:8080/mahbub/turk16/index.html}. No data was recorded from the pre-trial because participants had not provided informed consent at this point. 
...
\newtext{To investigate the effect of these features on the balance between target models they are also included and discussed in the faceoff model of section~\ref{sec:faceoff}.}
