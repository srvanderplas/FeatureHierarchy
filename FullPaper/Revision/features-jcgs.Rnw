...
\newdo{XXX this needs more details. }
Additional information about the model structure, parameter estimates, and interpretations are provided in Supplement~\ref{app:accuracy}. 
