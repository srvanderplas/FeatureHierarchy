...
Supplementary materials for this paper are available online; a written supplement provides additional details, and code and data are available on \href{http://github.com/srvanderplas/FeatureHierarchy}{github}.
\end{abstract}
