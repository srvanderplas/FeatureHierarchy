...
conf <- lmer(data=modeldata, conf_level~log(as.numeric(trial.time))+simpleoutcome+sdline_new+sdgroup_new+k_new+(1|dataset)+(1|ip_address))
...
Parameter & Estimate & Std.Error & z.value & $P$-value \\ 
  \hline
(Intercept) & 5.835 & 0.186 & 31.314 & $\le 0.0001$ \\ 
  $\tau$ & -0.246 & 0.016 & -15.794 & $\le 0.0001$ \\ 
  $\alpha_T$ & -0.588 & 0.207 & -2.843 & 0.0045 \\ 
  $\alpha_C$ & -1.957 & 0.408 & -4.800 & $\le 0.0001$ \\ 
  $\alpha_K$ & -0.069 & 0.019 & -3.548 & 0.0004 \\ [3pt]
  {\bf Outcome} \hfill trend & 0.000 & --- & --- & --- \\ 
  cluster & -0.024 & 0.022 & -1.083 & 0.2789 \\ 
  neither & -0.215 & 0.027 & -7.859 & $\le 0.0001$ \\ 
  both & -0.236 & 0.103 & -2.294 & 0.0218 \\ 
   \hline
\end{tabular}
\caption{\label{tab:conf}}
\end{table}
\end{appendix}
\end{document}