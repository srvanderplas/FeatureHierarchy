...
\begin{figure}
<<histogram, echo=FALSE, fig.width=8, fig.height=5, out.width='.6\\textwidth'>>=
library(ggplot2)
...
Parameter & Estimate & Std. Error & z.value & P values \\ 
  \hline
$\mu$ & 2.660 & 0.108 & 24.586 & $\le 10^{-12}$ \\ 
  $\alpha_0$ & 0.231 & 0.014 & 16.366 & $\le 10^{-12}$ \\
    $\alpha_{K = 3}$ & 0.000 & --- & --- & --- \\ 
...
{\bf Plot Type} \hfill  Plain & 0.000 & --- & --- & --- \\ 
  ...
  Trend & 0.148 & 0.019 & 7.815 & $\le 10^{-12}$ \\ 
  Trend + Error & 0.166 & 0.019 & 8.759 & $\le 10^{-12}$ \\ 
  Color + Ellipse & 0.205 & 0.019 & 10.735 & $\le 10^{-12}$ \\ 
  Color + Shape & 0.214 & 0.019 & 11.281 & $\le 10^{-12}$ \\ 
  Color + Trend & 0.215 & 0.019 & 11.345 & $\le 10^{-12}$ \\ 
  Color + Shape + Ellipse & 0.205 & 0.019 & 10.699 & $\le 10^{-12}$ \\ 
  Color + Ellipse + Trend + Error & 0.252 & 0.019 & 13.215 & $\le 10^{-12}$ \\ [3pt]
 {\bf Target} \hfill   Trend & -0.182 & 0.016 & -11.665 & 0.000e+00 \\ 
