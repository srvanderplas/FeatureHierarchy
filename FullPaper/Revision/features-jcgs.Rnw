...
\newtext{The approach taken in this paper is to utilize principles of preattentive perception, gestalt heuristics, and statistical lineups in order to better understand the effect of additional aesthetics on the perception of statistical graphics.}
