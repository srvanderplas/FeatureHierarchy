...
Figure~\ref{fig:onetarget} shows an overview of the number of evaluations by plot type (outlines) and the number of times participants chose at least one of the targets (dark shaded areas). Plot types  associated with  clustering as shown in table~\ref{tab:plotaesthetics} lead to significantly fewer correct evaluations. This, together with a  possible cause is discussed in more detail in section~\ref{sec:sentiment}. 

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: Response is constant}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in confint(gvl.model, method = "{}Wald"{}): object 'gvl.model' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in names(gvl.fixef) <- c("{}LB"{}, "{}UB"{}): object 'gvl.fixef' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in fixef(gvl.model): object 'gvl.model' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gvl.fixef[1, 1:3] <- 0: object 'gvl.fixef' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in factor\_contrasts(model): no 'model.matrix' method for 'model' found!}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cld(type\_compare): object 'type\_compare' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in fixef(gvl.model): object 'gvl.model' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'gvl.fixef' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(data = gvl.fixef): object 'gvl.fixef' not found}}\end{kframe}
\end{knitrout}
